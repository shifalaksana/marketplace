...
if(isset($_POST['submit'])){
    ...
    if (mysqli_num_rows($login) > 0) {
        ...
        header('location:utamapenjual.php?page=home'); 
    } else { 
...
<div class="login-container popup-animation">
    <h2>Welcome Back Seller Powerians!</h2>
    <form action="indexpenjual.php" method="POST">
        <div class="mb-3">
        ...
        <div class="login-links">
            <a href="registerpenjual.php">Daftar</a>
            <a href="forget_passwordpenjual.php">Lupa Password?</a>
        </div>
    </form>
</div>

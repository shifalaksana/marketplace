...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($cek_user) > 0) {
        ...
        $query = "INSERT INTO penjual (username, password, nama) VALUES ('$username', '$password', '$nama')";
...
<div class="register-container popup-animation">
    <h2>Ayo Gabung Menjadi Seller Powerians!</h2>
    <form action="registerpenjual.php" method="POST">
        ...
        <div class="login-link">
            <p>Sudah punya akun? <a href="indexpenjual.php">Login di sini</a></p>
        </div>
    </form>
</div>

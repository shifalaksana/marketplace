                              ...
                              <div class="row mb-4 d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                  ...
                                  <input id="quantity-<?php echo $row['id_produk']; ?>"
                                    min="1"
                                    name="products[<?php echo $row['id_produk']; ?>][quantity]"
                                    value="<?php echo $initial_qty; ?>"
                                    type="number"
                                ...
                                <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                  ...
                                  <!-- Include hidden input for product price -->
                                ...
                                <div class="col-12">
                                  <label>
                                    <input type="checkbox" id="selected-<?php echo $row['id_produk'];?>" name="products[<?php echo $row['id_produk']; ?>][selected]" value="<?php echo $row['id_produk']; ?>">
                                  </label>
                                </div>
                              </div>
                              <hr class="my-4">

...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($cek_user) > 0) {
        ...
        if (mysqli_query($koneksi, $query)) {
            ...
            echo "<script>alert('Password baru berhasil dibuat. Password baru Anda adalah: $new_password'); window.location.href='index.php';</script>";
        } else {
            echo "<script>alert('Terjadi kesalahan saat memperbarui password.'); window.location.href='forgot_password.php';</script>";
        }
    } else {
        echo "<script>alert('Username tidak ditemukan!'); window.location.href='forgot_password.php';</script>";
    }
}
?>
